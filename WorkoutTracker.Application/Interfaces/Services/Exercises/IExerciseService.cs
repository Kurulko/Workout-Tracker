...
public interface IExerciseService : IBaseService
{
    ...
    Task<IEnumerable<Exercise>> GetInternalExercisesAsync(ExerciseType? exerciseType = null, string? filterQuery = null, CancellationToken cancellationToken = default);
    ...
    Task UpdateInternalExerciseAliasesAsync(long exerciseId, string[] aliases, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Exercise>> GetUserExercisesAsync(string userId, ExerciseType? exerciseType = null, string? filterQuery = null, CancellationToken cancellationToken = default);
    ...
    Task UpdateUserExerciseAliasesAsync(string userId, long exerciseId, string[] aliases, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Exercise>> GetAllExercisesAsync(string userId, ExerciseType? exerciseType = null, string? filterQuery = null, CancellationToken cancellationToken = default);
    Task<IEnumerable<Exercise>> GetUsedExercisesAsync(string userId, ExerciseType? exerciseType = null, string? filterQuery = null, CancellationToken cancellationToken = default);
