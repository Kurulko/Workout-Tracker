...
public static class FileServiceExtensions
{
    ...
    public static async Task<string?> GetImage(this IFileService fileService, FileUploadModel? file, string directory, int maxFileSizeInMegabytes, bool isUniqueName = true)
    {
        if (file is null)
            return null;
