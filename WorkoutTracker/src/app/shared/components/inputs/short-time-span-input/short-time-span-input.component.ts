...
@Component({
  selector: 'app-short-time-span-input',
  templateUrl: './short-time-span-input.component.html',
  styleUrls: ['./short-time-span-input.component.css'],
  providers: [
    {
      provide: NG_VALIDATORS,
      useExisting: forwardRef(() => ShortTimeSpanInputComponent),
      multi: true,
    },
    {
...
export class ShortTimeSpanInputComponent extends BaseEditorComponent<TimeSpan> implements OnInit {
  @Input() min: number = 0;
