...
public class ExerciseAliasService : BaseWorkoutService<ExerciseAlias>, IExerciseAliasService
{
    readonly ExerciseRepository exerciseRepository;
    public ExerciseAliasService(ExerciseAliasRepository exerciseAliasRepository, ExerciseRepository exerciseRepository) : base(exerciseAliasRepository)
    {
