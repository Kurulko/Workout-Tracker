...
public interface IMuscleSizeService
{
    ...
    Task<ServiceResult<IQueryable<MuscleSize>>> GetUserMuscleSizesInInchesAsync(string userId, long? muscleId =  null, DateTime? date = null);
    Task<ServiceResult<IQueryable<MuscleSize>>> GetUserMuscleSizesInCentimetersAsync(string userId, long? muscleId =  null, DateTime? date = null);
